...
/** Over the combos table in the back-right corner, clear of the sightline from the door to the plaque. */
export const CHANDELIER = { x: 4.0, z: -11.3, top: 3.8, bottom: 2.75, r: 0.42 };
